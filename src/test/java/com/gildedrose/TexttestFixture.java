...
public class TexttestFixture {
    ...
    public static String generateDays(int days) {
        String output = "";
        ...
        AbstractItem[] items = new AbstractItem[] {
                ...
                new ImmutableItem("Sulfuras, Hand of Ragnaros", 0, 80), //
                new ImmutableItem("Sulfuras, Hand of Ragnaros", -1, 80),
    ...
    public void testScenario() {
        String aMonth = generateDays(31);

        assertEquals(EXPECTED_OUTPUT, aMonth);
    }



    public static final String EXPECTED_OUTPUT = "OMGHAI!\n" +
            "-------- day 0 --------\n" +
            "name, sellIn, quality\n" +
